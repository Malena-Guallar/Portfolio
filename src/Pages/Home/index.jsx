  ...
  return (
    <div className="container">
      ...
      <div className="home">
        ...
        <motion.img className="image" alt="Image" src="./_Portfolio/images/image1.svg" animate={{rotate: [0, 90, 180, 270, 360]}} transition={{duration: 10, repeat: Infinity, ease:"linear"}}/>
