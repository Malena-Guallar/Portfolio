        ...
        <Project
            ...
            content={
                <div className="content">
                    <p>This project was designed as a group exercise in order to learn how to use <b>API requests</b> to create a dynamic webpage. We used several API in order to render time and weather informations, with a map, centered on Paris' tenth arrondissement, with drawings of the neighbouring parks and green spaces. We used Paris Data and a weather API.</p>
